...
Only the Intake, Pedagogy (Curriculum, Lesson Planning, Teacher), and
Storyboarding stages are wired so far. The remaining three agents from
the architecture document's execution chain are added in later sprints,
in the same fixed, linear order.
"""
...
def build_video_generation_graph(
    ...
    Returns:
        ...
        concept sections, paces and localizes those sections for a Class 6 lesson, and
        turns them into timed storyboard beats.
    """
